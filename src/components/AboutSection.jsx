        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <img
              src="/me.jpg"
              alt="Ryan Sarcinelli"
              className="rounded-full w-md border-4 border-primary shadow-lg object-cover"
            />{" "}
            ...
            <p className="text-muted-foreground">
              {" "}
              I'm a Computer Science student at UFES and a front-end developer
              at Cinética Júnior, with hands-on experience in Next.js, React,
              Vue.js, and Node.js.{" "}
            </p>{" "}
            <p className="text-muted-foreground">
              {" "}
              I am currently seeking internship
              opportunities to apply my skills, collaborate with agile teams,
